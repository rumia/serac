...
abstract class Serac_Base implements ArrayAccess
{
	...
	{
		$uri	= '';
		$mode = Serac::getConfig('uri_mode', Serac::DEFAULT_URI_MODE);
		switch ($mode)
		{
			case 'request_uri':
			...
			case 'query_string':
				$uri = Serac::getQueryVar(Serac::getConfig('uri_param', 'uri'), '');
				break;
	...
	public static function autoloadClass($class)
	{
		...
		if ($path = Serac::getFilePath($file, CLASSDIR))
		{
			require_once $path;
